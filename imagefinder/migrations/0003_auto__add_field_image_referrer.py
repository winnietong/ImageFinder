...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Image.referrer'
        db.add_column(u'imagefinder_image', 'referrer',
                      self.gf('django.db.models.fields.CharField')(max_length=30, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Image.referrer'
        db.delete_column(u'imagefinder_image', 'referrer')
    ...
    models = {
        ...
        u'imagefinder.image': {
            ...
            'referrer': ('django.db.models.fields.CharField', [], {'max_length': '30', 'null': 'True', 'blank': 'True'}),
