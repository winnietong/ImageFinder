...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Tag'
        db.create_table(u'imagefinder_tag', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=50)),
        ))
        db.send_create_signal(u'imagefinder', ['Tag'])

        # Adding model 'Image'
        db.create_table(u'imagefinder_image', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('apiURL', self.gf('django.db.models.fields.CharField')(max_length=200, null=True)),
            ...
            ('thumbnailURL', self.gf('django.db.models.fields.URLField')(max_length=200, null=True)),
        ))
        db.send_create_signal(u'imagefinder', ['Image'])

        # Adding M2M table for field favorites on 'Image'
        m2m_table_name = db.shorten_name(u'imagefinder_image_favorites')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('image', models.ForeignKey(orm[u'imagefinder.image'], null=False)),
            ('user', models.ForeignKey(orm[u'imagefinder.user'], null=False))
        ))
        db.create_unique(m2m_table_name, ['image_id', 'user_id'])

        # Adding M2M table for field tags on 'Image'
        m2m_table_name = db.shorten_name(u'imagefinder_image_tags')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('image', models.ForeignKey(orm[u'imagefinder.image'], null=False)),
            ('tag', models.ForeignKey(orm[u'imagefinder.tag'], null=False))
        ))
        db.create_unique(m2m_table_name, ['image_id', 'tag_id'])

        # Adding model 'User'
        db.create_table(u'imagefinder_user', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal(u'imagefinder', ['User'])

        # Adding M2M table for field groups on 'User'
        m2m_table_name = db.shorten_name(u'imagefinder_user_groups')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('user', models.ForeignKey(orm[u'imagefinder.user'], null=False)),
        ...
        m2m_table_name = db.shorten_name(u'imagefinder_user_user_permissions')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('user', models.ForeignKey(orm[u'imagefinder.user'], null=False)),
    ...
    def backwards(self, orm):
        # Deleting model 'Tag'
        db.delete_table(u'imagefinder_tag')

        # Deleting model 'Image'
        db.delete_table(u'imagefinder_image')

        # Removing M2M table for field favorites on 'Image'
        db.delete_table(db.shorten_name(u'imagefinder_image_favorites'))

        # Removing M2M table for field tags on 'Image'
        db.delete_table(db.shorten_name(u'imagefinder_image_tags'))

        # Deleting model 'User'
        db.delete_table(u'imagefinder_user')

        # Removing M2M table for field groups on 'User'
        db.delete_table(db.shorten_name(u'imagefinder_user_groups'))

        # Removing M2M table for field user_permissions on 'User'
        db.delete_table(db.shorten_name(u'imagefinder_user_user_permissions'))
